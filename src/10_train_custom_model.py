...
Module:
10 - Train Custom Face Recognition Model
=========================================================
"""
...
joblib.dump(model, MODEL_PATH / "custom_svm_model.pkl")
joblib.dump(scaler, MODEL_PATH / "custom_scaler.pkl")
joblib.dump(encoder, MODEL_PATH / "custom_label_encoder.pkl")
